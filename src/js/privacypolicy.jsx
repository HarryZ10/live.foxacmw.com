...
export default function PrivacyPolicy() {
    ...
    return (
        ...
        <div id="privacypolicy" className="section">
            ...
            <p><span className="arrowlink">foxacmw.com</span> does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to <span><a className="arrowlink red" href="mailto:acm.gfu@gmail.com">contact us immediately</a></span>  and we will do our best efforts to promptly remove such information from our records.</p>
        </div>
    );
}