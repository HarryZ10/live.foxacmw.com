...
export default function TeamTwo() {
    ...
    var content = [];
    var team2 = LinkedIn.team2;

    for (var i = 0; i < team2.length; i++) {
        content.push(TeamInfo(team2[i].name, team2[i].url))
    }
    ...
    const { isLoading, error, data}  = useFetch(
        `https://gitlab.com/api/v4/projects/33664484/repository/commits?ref_name=main&since=2022-04-02T01:00:00.000Z&until=2022-04-03T08:15:00.000Z&all=true&per_page=500&page=${page}`,
        {
            headers: {
